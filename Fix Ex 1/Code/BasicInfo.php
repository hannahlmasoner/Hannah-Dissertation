...
<form id="content" class="basicInfo" name="Demographics"
    ...
    <fieldset>
        ...
        <section class="radioButtons">
            <h3>Did you play sports in high school?</h3>
        ...
        <section class="radioButtons">
            <h3>Did you play sports in college?</h3>
            <label><input name="Athlete" type="radio" value="Yes"   required/>Yes</label>
            <label><input name="Athlete" type="radio" value="No"    required/>No</label>
        </section>

        <section class="radioButtons">
            <h3>Do you currently compete for a collegiate level varsity sports team?</h3>
            <label><input name="Athlete" type="radio" value="Yes"   required/>Yes</label>
            <label><input name="Athlete" type="radio" value="No"    required/>No</label>
        </section>     
 	        ...
 	        <section>
            <label>
                <h3>How many hours a week do you spend exercising or doing physical activity?</h3>
